...
class GynecologistScreen extends StatefulWidget {
  const GynecologistScreen({super.key});

  @override
  State<GynecologistScreen> createState() => _GynecologistScreenState();
}

class _GynecologistScreenState extends State<GynecologistScreen> {
  @override
